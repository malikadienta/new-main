                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            ...
                            <div class="text-uppercase">Fullstack Web Developer</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">Wellcome To My Profile</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">MALIKA DIENTA PRAKASIWI</span></h1>
                ...
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img " src="{{ asset('foto/profile/'. GetMetaValue('_foto')) }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
                ...
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            ...
                            {{-- <a class="text-gradient" href="#!"><i class="bi bi-envelope"></i></a> --}}
                        </div>
                    </div>
                </div>
            </div>
